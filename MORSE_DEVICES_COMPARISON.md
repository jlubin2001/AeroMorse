...
| | **Adap2U** | **Darci USB** | **morAce** | **AeroMorse** |
|---|---|---|---|---|
| Naming | "Configurations" | "Modes" (toggled with command codes) | Single set of codes + "shortcuts" via `morse_code_shortcuts.py` | **Ten groups** (g0 always-on; g1 keyboard, g2 mouse, g3 macros, g4 scanning/Switch Control, g5 media (USB HID Consumer Controls), g6–g9 customisable) |
